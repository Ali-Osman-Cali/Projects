...
innerJoin_pipe <- sales %>%inner_join(customers, by= 'customer_id')
innerJoin_pipe
...
## Perform the full join operation
## in R
###########################################################

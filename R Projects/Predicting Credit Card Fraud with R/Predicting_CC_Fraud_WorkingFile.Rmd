...
dt_orig_predic <- predict(dt_orig, test, type="prob")


#B. Decision Tree - Assign class to probabilities
dt_orig_test <- factor(ifelse(dt_orig_predic$yes > 0.50, "yes", "no"))
...
nb_orig_predic <- predict(nb_orig, test, type="prob")

#B. NB - Assign class to probabilities
nb_orig_test <- factor(ifelse(nb_orig_predic$yes > 0.50, "yes", "no"))
...
lda_orig_predic <- predict(lda_orig, test, type="prob")



#B. LDA - Assign class to probabilities
lda_orig_test <- factor(ifelse(lda_orig_predic$yes > 0.50, "yes", "no"))
...
################################################
#A. Decision Tree Model predictions
dt_smote_predic <- predict(dt_smote, test, type="prob")


#B. Decision Tree - Assign class to probabilities
dt_smote_test <- factor(ifelse(dt_smote_predic$yes > 0.50, "yes", "no"))
...
##############################################
#A. NB Model predictions
nb_smote_predic <- predict(nb_smote, test, type="prob")

#B. NB - Assign class to probabilities
nb_smote_test <- factor(ifelse(nb_smote_predic$yes > 0.50, "yes", "no"))
...
######################################
#A. LDA Model predictions
lda_smote_predic <- predict(lda_smote, test, type="prob")



#B. LDA - Assign class to probabilities
lda_smote_test <- factor(ifelse(lda_smote_predic$yes > 0.50, "yes", "no"))
...
#################################################
#A. Decision Tree Model predictions
dt_adas_predic <- predict(dt_adas, test, type="prob")


#B. Decision Tree - Assign class to probabilities
dt_adas_test <- factor(ifelse(dt_adas_predic$yes > 0.50, "yes", "no"))
...
###############################################
#A. NB Model predictions
nb_adas_predic <- predict(nb_adas, test, type="prob")

#B. NB - Assign class to probabilities
nb_adas_test <- factor(ifelse(nb_adas_predic$yes > 0.50, "yes", "no"))
...
#######################################
#A. LDA Model predictions
lda_adas_predic <- predict(lda_adas, test, type="prob")



#B. LDA - Assign class to probabilities
lda_adas_test <- factor(ifelse(lda_adas_predic$yes > 0.50, "yes", "no"))
...
###################################################
#A. Decision Tree Model predictions
dt_dbsmote_predic <- predict(dt_dbsmote, test, type="prob")


#B. Decision Tree - Assign class to probabilities
dt_dbsmote_test <- factor(ifelse(dt_dbsmote_predic$yes > 0.50, "yes", "no"))
...
#################################################
#A. NB Model predictions
nb_dbsmote_predic <- predict(nb_dbsmote, test, type="prob")

#B. NB - Assign class to probabilities
nb_dbsmote_test <- factor(ifelse(nb_dbsmote_predic$yes > 0.50, "yes", "no"))
...
#########################################
#A. LDA Model predictions
lda_dbsmote_predic <- predict(lda_dbsmote, test, type="prob")



#B. LDA - Assign class to probabilities
lda_dbsmote_test <- factor(ifelse(lda_dbsmote_predic$yes > 0.50, "yes", "no"))

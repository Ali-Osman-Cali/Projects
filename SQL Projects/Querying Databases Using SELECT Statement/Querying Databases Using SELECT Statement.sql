...
SELECT * FROM employees
WHERE first_name IN ('Cathie' OR first_name = 'Mark' OR first_name = 'Nathan');


-- NOT IN
SELECT * FROM employees
WHERE first_name NOT IN ('Cathie' OR first_name = 'Mark' OR first_name = 'Nathan');
...
-- 4.4: Extract a list of all employees whose first name includes 'AR'
SELECT * FROM employees
WHERE first_name LIKE('%AR%');

-- 4.5: Extract a list of all employees whose first name includes 'MAR_'
SELECT * FROM employees
WHERE first_name LIKE ('MAR_');

-- 4.6: Extract a list of all employees whose first name doesn't include 'MAR'
SELECT * FROM employees
WHERE first_name NOT LIKE ('%MAR%');

-- 4.7: Extract all individuals from the 'employees' table whose first name 
-- starts with 'Mark'
SELECT * FROM employees
WHERE first_name LIKE ('MARK%');

-- 4.8: Extract all individuals from the employees table whose first name 
...
-- 5.7: Select the names of all departments whose department number value is not null
...
-- 6.7: Retrieve a list of all employees who were employed on or before 1st of February, 1990
SELECT * FROM employees
WHERE hire_date <= '1990-02-01';

-- 6.8: Retrieve a list of all female employees who were hired on or after 1st January, 1999. 
SELECT * FROM employees
...
-- From 5.5: Count how many first names are in the employees table
